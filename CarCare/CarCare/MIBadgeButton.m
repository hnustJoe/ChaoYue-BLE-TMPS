...
- (void)setuobadgeLableWidth:(CGFloat)width height:(CGFloat)heigth{
    [badgeLabel setFrame:CGRectMake(badgeLabel.frame.origin.x, badgeLabel.frame.origin.y,width,  heigth)];
    [self setupBadgeStyle];
